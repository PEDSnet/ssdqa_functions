...
<!-- This heat map shows the proportion of "unstable" concept_ids across time. The check will look for concept_ids that fall a certain number of MAD (provided by the user) away from the all site median number of mappings throughout the user specified time span. The "instability" of the concept is represented by both the number and proportion of outliers within a given site + concept_id pair. -->
