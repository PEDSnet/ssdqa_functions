...
no_time <- read_csv(file = paste0(config('base_dir'), '/results/ss_ms_nt.csv')) #%>%
  # mutate(site = case_when(site == 'chop' ~ 'site 1',
  #                         site == 'colorado' ~ 'site 2',
...
All output was generated in a CDM -> Source vocabulary direction, using CDM (SNOMED) codes related to JIA and the source (ICD) codes they are mapped from.
