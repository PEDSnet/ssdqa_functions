...
This output calculates the number of mappings per concept_id, then displays the number of MAD that concept_id from the all site median number of mappings. Here, warmer colors indicate outlying concept_ids.
