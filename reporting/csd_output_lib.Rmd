...
Two graphs are output:
  ...
  * a line graph displaying the proportion of that concept_id at each site over time, with the Euclidean distance available in the tooltip when hovering over the line
