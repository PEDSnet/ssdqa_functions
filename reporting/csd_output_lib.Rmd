...
For each site in the cohort & each concept in the variable, this graph summarizes the MAD value for that concept_id (size of the dot), the proportion representing how often that concept_id is used (color of the dot), and whether that concept_id is anomalous (stars).
