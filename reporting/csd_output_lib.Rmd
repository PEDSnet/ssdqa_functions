...
This check outputs a control chart that highlights anomalies in the count of patients per concept_id in the provided variable. Blue dots along the line indicate non-anomalous values, while orange dots are anomalies.
...
ss_anom_at <- csd_output(process_output = get_results('csd_ss_at'),
                        ...
                        vocab_tbl = vocabulary_tbl('concept'),
                        num_mappings = 10,
                        filtered_var = 'polyarticular_jia'
                        )
...
This output is currently in progress and will be added to this report at a later date
