...
1. A histogram displaying the distribution of days between events for the cohort. The binsize (bar width) is automatically determined by the geom_histogram function
